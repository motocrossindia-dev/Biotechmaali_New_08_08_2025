...
class EndUrl {
  ...
  static String categoryFilterProductUrl =
      "${baseUrl}filters/main_productsFilter/";
  ...
  static String removeCouponUrl = "${baseUrl}order/removeCoupon/";
  static String comboOffersUrl = "${baseUrl}combo/combo_offers_list/";
